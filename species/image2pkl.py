...
# 主要函数接口
def load_data(dirname="cutImage", pklpath='cutImage/',
                resize_pics=(64, 64), shuffle=True, one_hot=False):

    dataset_file = os.path.join(dirname, 'cutset.pkl')
...
if __name__ == "__main__":
    load_data(resize_pics=(64, 64),shuffle=True,one_hot=True)